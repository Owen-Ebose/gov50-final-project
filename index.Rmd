...
Working for a local government is associated with the greatest increase in turnout, followed by being self-employed, working for a state government, working for a non-profit, then working for the federal government. None of the 95% confidence intervals contain zero, so, in line with our conclusion based on the p-values, we can conclude that the coefficients are significantly different from zero at the five percent level.

...
In light of my hypothesis, I expect to find that workers for the government, non-profits, and the self-employed participate the most, while workers for for-profits participate the least. Government workplaces are proximate to politics in the sense that their mandates and directives are directly determined through the political process. Their bosses are or are appointed by politicians. Their day-to-day work experiences are shaped by politics so they are likely invested in political decision making. Those who are self-employed set their own work hours and can therefore carve out the time needed for political activity such as voting. Non-profit workplaces are often small, meaning workers have more opportunities to directly interface with decision makers. For-profit workplaces are often large and hierarchical; average workers have little opportunity to shape the direction of the company and limited control over their schedules, and may or may not be close to the political process. 

I am broadly predicting that workers for for-profits participate less than workers for the other classes. To operationalize this hypothesis for the purpose of regression analysis, I combine the six classes into two employment "types": *"for-profit"* and *"other"*. I have identified unique features of the classes in the "other" category that I predict are conducive to participation, but have not proposed a shared feature that justifies their collation as one type. For that reason, I will continue to display results for both the broad types and the granular classes throughout the project. If I find that the classes in the "other" category are very similar in their propensity to participate, I will explore more deeply possible connections between them. My hypothesis will be supported if I discover that workers at for-profits turned out a lesser rate than workers for the other classes in 2022. I am comfortable using voter turnout as a measure of democratic participation because voting is the most basic and accessible form of participation, meaning it should capture workers of all degrees of commitment: the least committed participants will vote, and the most committed participants will vote *and* engage in other democratic activities such as attending rallies.  
...
lm1 <- summary(lm(voted_num ~ employment_type + house_income_num + college_degree + state + sex + race, data = census))
...
var_labels <- c(
  "employment_typeNon-company" = "Workers at non-companies",
  "house_income_num" = "Annual household income",
  "college_degree" = "Worker has college degree")
modelsummary::modelsummary(list(lm1),
